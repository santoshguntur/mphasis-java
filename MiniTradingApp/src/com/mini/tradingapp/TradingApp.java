...
/**
 * Main program to test the trading app.*/
public class TradingApp {
    ...
    static {
        ...
        Stock infy = new Stock(100, "INFOSYS", "INFY");
        ...
        orderManagement.createOrder(100, OrderType.BUY, 100, infy, "101");
        orderManagement.createOrder(99, OrderType.BUY, 100, infy, "101");
        orderManagement.createOrder(101, OrderType.BUY, 90, infy, "101");
        orderManagement.createOrder(100, OrderType.SELL, 100, infy, "101");
        orderManagement.createOrder(99, OrderType.SELL, 20, infy, "101");
        orderManagement.createOrder(80, OrderType.BUY, 100, infy, "101");
        orderManagement.createOrder(103, OrderType.SELL, 100, infy, "101");
        orderManagement.createOrder(50, OrderType.BUY, 100, infy, "101");
        orderManagement.createOrder(34, OrderType.BUY, 100, infy, "101");
        orderManagement.createOrder(99, OrderType.BUY, 100, infy, "101");
